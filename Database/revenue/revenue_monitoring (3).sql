...
--
-- Host: 127.0.0.1
-- Generation Time: May 17, 2021 at 05:36 PM
...
CREATE TABLE `value_books_details` (
...
CREATE TABLE `value_books_stock_record` (
  ...
  `value_record_ID` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Indexes for table `center_items`
--
ALTER TABLE `center_items`
  ADD PRIMARY KEY (`assign_code`),
  ADD KEY `assign_center` (`assign_center`),
  ADD KEY `assign_item` (`assign_item`);
...
--
-- Indexes for table `collection_payment_entries`
--
ALTER TABLE `collection_payment_entries`
  ADD PRIMARY KEY (`pay_ID`),
  ADD KEY `collection_payment_entries_ibfk_1` (`pay_revCenter`);
...
ALTER TABLE `commission_details`
  ...
  ADD KEY `commission_details_ibfk_1` (`commission_center`);
...
ALTER TABLE `daily_entries`
  ...
  ADD KEY `daily_entries_ibfk_1` (`daily_revCenter`),
  ADD KEY `daily_entries_ibfk_2` (`revenueItem`);
...
ALTER TABLE `revenue_items`
  ADD PRIMARY KEY (`revenue_item_ID`);

--
-- Indexes for table `target_entries`
--
ALTER TABLE `target_entries`
  ADD PRIMARY KEY (`target_ID`),
  ADD KEY `target_revCenter` (`target_revCenter`);

--
-- Indexes for table `value_books_details`
--
ALTER TABLE `value_books_details`
  ADD PRIMARY KEY (`value_book_ID`);

--
-- Indexes for table `value_books_stock_record`
--
ALTER TABLE `value_books_stock_record`
  ADD PRIMARY KEY (`value_record_ID`),
  ADD KEY `value_book` (`value_book`),
  ADD KEY `value_stock_revCenter` (`value_stock_revCenter`);
...
--
ALTER TABLE `daily_entries`
  MODIFY `entries_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=45;

--
-- AUTO_INCREMENT for table `target_entries`
--
ALTER TABLE `target_entries`
  MODIFY `target_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT for table `value_books_stock_record`
--
ALTER TABLE `value_books_stock_record`
  MODIFY `value_record_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
